...
# Tokenize INPUT_ACTIONLINT_FLAGS into an array (quote-aware, prevents injection)
actionlint_flags=()
...
# Tokenize INPUT_REVIEWDOG_FLAGS into an array (quote-aware, prevents injection)
reviewdog_flags=()
